...
const Register = () => {
  return (
    <>
      <div className='flex max-w-screen-2xl mx-auto bg-white'>
        <div className='w-0 xl:w-1/2 h-0 xl:h-screen invisible xl:visible brightness-75'>
            <img src={'/bg-register.svg'} width={600} height={707}></img>
        </div>
