    ...
    return (
        <footer className='max-w-screen-2xl bg-white mx-auto'>
            <div className='text-lg p-16'>
                <div className='flex flex-col xl:flex-row m-auto gap-10'>
                    ...
                    <div className='footer_links'>
                        {footerLinks.map((Link) => (
                            <div key={Link.title}
                                ...
                                <h3 className=' p-3 font-bold text-center xl:text-start'>{Link.title}</h3>
                                {Link.links.map((item) => (
                                    <a
                                        key={item.title}
                                        href={item.href}
                                        className="text-gray-400 flex flex-col p-3 text-center xl:text-start"
                                    >
                                        {item.title}
                                    </a>
                                ))}
