        ...
        <header className='max-w-screen-2xl h-max xl:h-24 overflow-hidden bg-white mx-auto border'>
            <nav className='flex max-w-screen-2xl h-max xl:h-24 p-2 xl:p-0 mx-auto justify-between'>
                ...
                <div className='flex flex-row h-full'>
                    <div className={`${isOpen ? 'hidden' : 'p-0 xl:p-6 w-0 xl:w-10/12 h-0 xl:h-24 text-lg invisible xl:visible justify-center'}`}>
                        <ul className={`${isOpen ? 'hidden' : 'flex m-3 gap-14'}`}>
                    ...
                    <div className={`${isOpen ? 'hidden' : 'p-0 xl:p-6 w-0 xl:w-max h-0 xl:h-24 justify-end end-0 gap-6'}`}>
                        <ul className='flex text-lg p-2 gap-14'>
                            ...
                            <Link className='text-[20px] h-[44px] w-[106px] font-normal bg-[#1B7996] p-2 hover:bg-slate-300 rounded-[5px] text-white text-center m-auto' href={'/register'}>Daftar</Link>
                        </ul>
                    </div>
                </div>
            </nav>
